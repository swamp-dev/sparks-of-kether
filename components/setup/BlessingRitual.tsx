          ...
          <div className="relative mt-6 flex flex-col items-center gap-3">
            ...
            {stepStatus === 'awaiting' ? (
              ...
              <button
                ...
                data-action="advance"
                className="rounded border border-illumination px-4 py-2 text-sm tracking-widest focus:outline-none focus-visible:ring-2 focus-visible:ring-illumination/80"
              >
                Next
              </button>
            )}
