        ...
        <div className="relative text-center">
          ...
          <div className="relative mt-6 flex flex-col items-center gap-3">
            ...
            <button
              ...
              className="mt-4 rounded border border-illumination/50 px-4 py-2 text-xs uppercase tracking-widest focus:outline-none focus-visible:ring-2 focus-visible:ring-illumination/80"
            >
