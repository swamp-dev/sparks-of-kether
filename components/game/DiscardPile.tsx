  ...
  return (
    ...
    >
      <button
        ...
        className={`relative block w-20 rounded border bg-ground/40 p-1 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-illumination/80 disabled:cursor-default lg:w-12 ${
          dragActive
