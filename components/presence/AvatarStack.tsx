...
function AvatarToken({ peer, isActive, isViewer, onClick }: AvatarTokenProps): JSX.Element {
  ...
  return (
    <button
      ...
      className={
        onClick === undefined
          ? 'relative flex h-9 w-9 items-center justify-center rounded-full border-2 bg-ground/80 font-display text-xs uppercase tracking-wider text-veil transition-all duration-300 ease-emerge focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-illumination data-[online=false]:border-dashed data-[online=false]:opacity-60 data-[active=true]:shadow-glow-tiferet data-[active=true]:motion-safe:animate-breath'
          : 'relative flex h-9 w-9 items-center justify-center rounded-full border-2 bg-ground/80 font-display text-xs uppercase tracking-wider text-veil transition-all duration-300 ease-emerge hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-illumination data-[online=false]:border-dashed data-[online=false]:opacity-60 data-[active=true]:shadow-glow-tiferet data-[active=true]:motion-safe:animate-breath'
      }
    >
