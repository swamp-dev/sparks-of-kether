...
| 11 | Title card: **Sparks of Kether** in Cinzel display, off-white on indigo. Tagline "A cooperative ascent up the Kabbalistic Tree of Life." underneath. URL (TBD) at the bottom. | **Deliverable** — title card to be designed from scratch in production; no existing asset. Match Cinzel + indigo `#0e0a1f` + gold `#ffd700` from the live game. | 6 s | (sting only) |
